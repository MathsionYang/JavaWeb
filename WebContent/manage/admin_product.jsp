            ...
            <form action="/MonkeyShop/manage/admin_douserdel" id="myform" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach var="productInfo" items = "${plist }">
                        <tr>
                        	<td>${productInfo.PRODUCT_ID }</td>
                        	
                        	<td><img src="../imagesUpload/${productInfo.PRODUCT_FILENAME}" width="100" height= "100">${productInfo.PRODUCT_DESCRIPTION }</td>
                        	<td>
                        	<a href="admin_tocateupdate?id=${soncate.CATE_ID}">修改</a>
                        	<a href="javascript:catedel(${soncate.CATE_ID})">删除</a>
                        	</td>
                        </tr>
